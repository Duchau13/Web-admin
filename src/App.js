...
import Newimportinvoice from "./component/Importimvoice/Newimportinvoice";
import NewimportinvoiceDetail from "./component/Importimvoice/NewimportinvoiceDetail";
import ImportimvoiceDetailItem from "./component/Importimvoice/ImportimvoiceDetailItem";
  ...
  return (
    <div className="App">
      <Routes>
          ...
          <Route path="/importinvoice/new" element ={<Newimportinvoice/>} />
          <Route path="/importinvoices/detail/:id_i_invoice" element ={<NewimportinvoiceDetail/>} />
          <Route path="/importinvoices/detail/:id_i_invoice/:id_u_ingredient" element ={<ImportimvoiceDetailItem/>} />
